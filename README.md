...
## Оглавление
1. [Описание](#Описание)
2. [Элементная база](#Элементная-база)
3. [Используемая периферия микроконтроллера](#Используемая-периферия-микроконтроллера)
4. [Принцип работы](#Принцип-работы)
5. [Возможности контроллера](#Возможности-контроллера)
6. [Фото и видео демонстрации](#Фото-и-видео-демонстрации)
____
## 1. Описание
