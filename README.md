...
2. [Элементная база](#2.-Элементная-база)
3. [Используемая периферия микроконтроллера](#3.-Используемая-периферия-микроконтроллера)
4. [Принцип работы](#Принцип-работы)
5. [Возможности контроллера](#Возможности-контроллера)
6. [Фото и видео демонстрации](#Фотои-видео-демонстрации)
____
## 1. Описание
